{{> cards/card_component componentName='commerce-product-prominentimage-clickable' }}

class commerce_product_prominentimage_clickableCardComponent extends BaseCard['commerce-product-prominentimage-clickable'] {
  ...
  static defaultTemplateName (config) {
    return 'cards/commerce-product-prominentimage-clickable';
  }
}

ANSWERS.registerTemplate(
  'cards/commerce-product-prominentimage-clickable',
  {{{stringifyPartial (read 'cards/commerce-product-prominentimage-clickable/template') }}}
);
ANSWERS.registerComponentType(commerce_product_prominentimage_clickableCardComponent);
